...
#file_path_conjscan=../results/intermediate/$directory/$method/$threshold_code/conjscan_performance.csv
#file_path_phaster=../results/intermediate/$directory/$method/$threshold_code/phaster_performance.csv
#file_path_joined=../results/intermediate/$directory/$method/$threshold_code/joined_performance.csv
...
do
	...
	echo "$threshold_code"
    	cat ../results/intermediate/training/genomes_train.csv | while read genome_file
	do
