...
A distance matrices are calculated (biopython) from the MSA. An unrooted gene tree in newick format is generated from this distance matrices using NJ (biopython).
